...
- [**EMA Cross Alert**](https://github.com/E2nuu/itunu-automation-portfolio/tree/main/trading-automations/ema-cross-alert) – Sends real-time alerts and push notifications when EMA(10) crosses EMA(20) on the M5 timeframe.
